...
The first example generates [4 ellipses](https://github.com/nilostolte/SVGPathParser/blob/main/src/ellipses/ellipse4.svg), each one rotated 45 degrees from the previous one. One uses [ellipse4.bat](https://github.com/nilostolte/SVGPathParser/blob/main/src/ellipses/ellipse4.bat) to produce it and the reslt give the following pattern:
